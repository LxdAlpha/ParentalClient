 ...
 * @Description: 可放大缩小图片、切割图片的imageview
 * @author kesar
 * @date 2015-12-2
 */
        ...
        ViewTreeObserver.OnGlobalLayoutListener
{
    ...
    private class AutoScaleRunnable implements Runnable
    {
         ...
         *
         * <p>
         * Description:传入目标缩放值，根据目标值与当前值，判断应该放大还是缩小
         * </p>
         *
         * @param targetScale
         * @param x
    ...
    /**
     *
     * @Description: 根据当前图片的Matrix获得图片的范围
     * @param @return
     * @return RectF
     * @throws
     * @author kesar
    ...
    public void onGlobalLayout()
    {
        if (once)
        {
            ...
            // 最小放缩
            RectF rectF = getMatrixRectF();
            SCALE_MID = rectF.height() > rectF.width() ? (getWidth() - mHorizontalPadding * 2)
                    / rectF.width()
                    : (getHeight() - mVerticalPadding * 2) / rectF.height();
            // 最大放缩
    ...
    /**
     *
     * @Description: 剪切图片成圆形，返回剪切后的bitmap对象
     * @param @return
     * @return Bitmap
     * @throws
     * @author kesar
    ...
    /**
     *
     * @Description: 剪切图片成正方形，返回剪切后的bitmap对象
     * @param @return
     * @return Bitmap
     * @throws
     * @author kesar
    ...
    /**
     *
     * @Description: 将方形bitmap转换为圆形bitmap
     * @param @param bitmap
     * @param @return
     * @return Bitmap
     * @throws
