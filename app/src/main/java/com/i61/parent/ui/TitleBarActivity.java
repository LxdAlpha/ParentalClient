...
public abstract class TitleBarActivity extends KJActivity {
	...
	public TextView mBackText; //返回按钮提示信息
	...
	protected void onStart() {
		try {
			...
			mBackText = findViewById(R.id.titlebar_text_exittip);
	...
	public void widgetClick(View v) {
		super.widgetClick(v);
		switch (v.getId()) {
			case R.id.titlebar_img_back:	      //点击返回按钮
				onBackClick();
				break;
			...
			case R.id.titlebar_text_menu:
				onTvMenuClick();
				break;
			case R.id.titlebar_text_exittip:  //点击返回按钮的提示文字等同于点击返回按钮
				onBackClick();
				break;
			default:
				break;
